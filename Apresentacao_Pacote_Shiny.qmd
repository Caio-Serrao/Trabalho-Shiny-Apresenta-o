...
de output que foram definidos no UI (tabela, gráfico, dataframe...). Ou seja,
as render functions são o objeto intermediário entre inputs e outputs.
...
Elas possibilitam também a utilização de outros pacotes interativos possuem suporte para renderizar
seus outputs no Shiny. Entre eles *DT*, *Plotly* e *Leaflet*
